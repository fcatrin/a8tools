...
public static Sym symtableBuiltin[] = {
	...
	new Sym("TOPSTK",  0x0090), new Sym("TOPSTK+1",0x0091), new Sym("MEOLFLG", 0x0092),
	...
	new Sym("STACKP",  0x0318), new Sym("TSTAT",   0x0319), new Sym("HATABS",  0x031a), /* HATABS 1_34 */
	new Sym("PUPBT1",  0x033d), new Sym("PUPBT2",  0x033e), new Sym("PUPBT3",  0x033f),
	new Sym("B0_ICHID",0x0340), new Sym("B0_ICDNO",0x0341), new Sym("B0_ICCOM",0x0342), new Sym("B0_ICSTA",0x0343),
	new Sym("B0_ICBAL",0x0344), new Sym("B0_ICBAH",0x0345), new Sym("B0_ICPTL",0x0346), new Sym("B0_ICPTH",0x0347),
	new Sym("B0_ICBLL",0x0348), new Sym("B0_ICBLH",0x0349), new Sym("B0_ICAX1",0x034a), new Sym("B0_ICAX2",0x034b),
	new Sym("B0_ICAX3",0x034c), new Sym("B0_ICAX4",0x034d), new Sym("B0_ICAX5",0x034e), new Sym("B0_ICAX6",0x034f),
	new Sym("B1_ICHID",0x0350), new Sym("B1_ICDNO",0x0351), new Sym("B1_ICCOM",0x0352), new Sym("B1_ICSTA",0x0353),
	new Sym("B1_ICBAL",0x0354), new Sym("B1_ICBAH",0x0355), new Sym("B1_ICPTL",0x0356), new Sym("B1_ICPTH",0x0357),
	new Sym("B1_ICBLL",0x0358), new Sym("B1_ICBLH",0x0359), new Sym("B1_ICAX1",0x035a), new Sym("B1_ICAX2",0x035b),
	new Sym("B1_ICAX3",0x035c), new Sym("B1_ICAX4",0x035d), new Sym("B1_ICAX5",0x035e), new Sym("B1_ICAX6",0x035f),
	new Sym("B2_ICHID",0x0360), new Sym("B2_ICDNO",0x0361), new Sym("B2_ICCOM",0x0362), new Sym("B2_ICSTA",0x0363),
	new Sym("B2_ICBAL",0x0364), new Sym("B2_ICBAH",0x0365), new Sym("B2_ICPTL",0x0366), new Sym("B2_ICPTH",0x0367),
	new Sym("B2_ICBLL",0x0368), new Sym("B2_ICBLH",0x0369), new Sym("B2_ICAX1",0x036a), new Sym("B2_ICAX2",0x036b),
	new Sym("B2_ICAX3",0x036c), new Sym("B2_ICAX4",0x036d), new Sym("B2_ICAX5",0x036e), new Sym("B2_ICAX6",0x036f),
	new Sym("B3_ICHID",0x0370), new Sym("B3_ICDNO",0x0371), new Sym("B3_ICCOM",0x0372), new Sym("B3_ICSTA",0x0373),
	new Sym("B3_ICBAL",0x0374), new Sym("B3_ICBAH",0x0375), new Sym("B3_ICPTL",0x0376), new Sym("B3_ICPTH",0x0377),
	new Sym("B3_ICBLL",0x0378), new Sym("B3_ICBLH",0x0379), new Sym("B3_ICAX1",0x037a), new Sym("B3_ICAX2",0x037b),
	new Sym("B3_ICAX3",0x037c), new Sym("B3_ICAX4",0x037d), new Sym("B3_ICAX5",0x037e), new Sym("B3_ICAX6",0x037f),
	new Sym("B4_ICHID",0x0380), new Sym("B4_ICDNO",0x0381), new Sym("B4_ICCOM",0x0382), new Sym("B4_ICSTA",0x0383),
	new Sym("B4_ICBAL",0x0384), new Sym("B4_ICBAH",0x0385), new Sym("B4_ICPTL",0x0386), new Sym("B4_ICPTH",0x0387),
	new Sym("B4_ICBLL",0x0388), new Sym("B4_ICBLH",0x0389), new Sym("B4_ICAX1",0x038a), new Sym("B4_ICAX2",0x038b),
	new Sym("B4_ICAX3",0x038c), new Sym("B4_ICAX4",0x038d), new Sym("B4_ICAX5",0x038e), new Sym("B4_ICAX6",0x038f),
	new Sym("B5_ICHID",0x0390), new Sym("B5_ICDNO",0x0391), new Sym("B5_ICCOM",0x0392), new Sym("B5_ICSTA",0x0393),
	new Sym("B5_ICBAL",0x0394), new Sym("B5_ICBAH",0x0395), new Sym("B5_ICPTL",0x0396), new Sym("B5_ICPTH",0x0397),
	new Sym("B5_ICBLL",0x0398), new Sym("B5_ICBLH",0x0399), new Sym("B5_ICAX1",0x039a), new Sym("B5_ICAX2",0x039b),
	new Sym("B5_ICAX3",0x039c), new Sym("B5_ICAX4",0x039d), new Sym("B5_ICAX5",0x039e), new Sym("B5_ICAX6",0x039f),
	new Sym("B6_ICHID",0x03a0), new Sym("B6_ICDNO",0x03a1), new Sym("B6_ICCOM",0x03a2), new Sym("B6_ICSTA",0x03a3),
	new Sym("B6_ICBAL",0x03a4), new Sym("B6_ICBAH",0x03a5), new Sym("B6_ICPTL",0x03a6), new Sym("B6_ICPTH",0x03a7),
	new Sym("B6_ICBLL",0x03a8), new Sym("B6_ICBLH",0x03a9), new Sym("B6_ICAX1",0x03aa), new Sym("B6_ICAX2",0x03ab),
	new Sym("B6_ICAX3",0x03ac), new Sym("B6_ICAX4",0x03ad), new Sym("B6_ICAX5",0x03ae), new Sym("B6_ICAX6",0x03af),
	new Sym("B7_ICHID",0x03b0), new Sym("B7_ICDNO",0x03b1), new Sym("B7_ICCOM",0x03b2), new Sym("B7_ICSTA",0x03b3),
	new Sym("B7_ICBAL",0x03b4), new Sym("B7_ICBAH",0x03b5), new Sym("B7_ICPTL",0x03b6), new Sym("B7_ICPTH",0x03b7),
	new Sym("B7_ICBLL",0x03b8), new Sym("B7_ICBLH",0x03b9), new Sym("B7_ICAX1",0x03ba), new Sym("B7_ICAX2",0x03bb),
	new Sym("B7_ICAX3",0x03bc), new Sym("B7_ICAX4",0x03bd), new Sym("B7_ICAX5",0x03be), new Sym("B7_ICAX6",0x03bf),
	new Sym("PRNBUF",  0x03c0), /* PRNBUF 1_39 */
	new Sym("SUPERF",  0x03e8), new Sym("CKEY",    0x03e9), new Sym("CASSBT",  0x03ea), new Sym("CARTCK",  0x03eb),
	new Sym("DERRF",   0x03ec), new Sym("ACMVAR",  0x03ed), /* ACMVAR 1_10 */
	...
	new Sym("R_CARTCS",0x9ffa), new Sym("R_CARTCS+1",0x9ffb),
	new Sym("R_CART",  0x9ffc), new Sym("R_CARTFG",  0x9ffd), new Sym("R_CARTAD",0x9ffe), new Sym("R_CARTAD+1",0x9fff),
	...
	new Sym("PBI",   0xd100), /* PBI 1_254 */    new Sym("PDVI",  0xd1ff), new Sym("PDVS",  0xd1ff),
